...
def get_options(option_type):
  ...
  """
  # Common
  tf.app.flags.DEFINE_string("env_type", "doom", "environment type (lab or gym or maze)")
  tf.app.flags.DEFINE_string("env_name", "doom_1",  "environment name")
  ...
  tf.app.flags.DEFINE_string("checkpoint_dir", "/tmp/unreal_checkpoints_4", "checkpoint directory")
  ...
  if option_type == 'training':
    ...
    tf.app.flags.DEFINE_string("log_file", "/tmp/unreal_log_4/unreal_log", "log file directory")
    ...
    tf.app.flags.DEFINE_integer("save_interval_step", 100 * 100, "saving interval steps")
    #tf.app.flags.DEFINE_boolean("grad_norm_clip", 40.0, "gradient norm clipping")
    tf.app.flags.DEFINE_boolean("grad_norm_clip", True, "gradient norm clipping")
