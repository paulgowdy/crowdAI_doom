...
class UnrealModel(object):
  ...
  def _create_base_network(self):
    ...
    self.base_input = tf.placeholder("float", [None, 84, 84, 1])
  ...
  def _base_conv_layers(self, state_input, reuse=False):
    with tf.variable_scope("base_conv", reuse=reuse) as scope:
      ...
      W_conv1, b_conv1 = self._conv_variable([8, 8, 1, 16],  "base_conv1")
  ...
  def _create_pc_network(self):
    # State (Image input)
    self.pc_input = tf.placeholder("float", [None, 84, 84, 1])
  ...
  def _create_vr_network(self):
    # State (Image input)
    self.vr_input = tf.placeholder("float", [None, 84, 84, 1])
  ...
  def _create_rp_network(self):
    self.rp_input = tf.placeholder("float", [3, 84, 84, 1])
